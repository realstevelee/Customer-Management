                ...
                <Dialog open={this.state.open} onClose={this.state.handleClose}>
                    ...
                    <DialogContent>
                        ...
                        <label htmlFor="raised-button-file">
                            <Button variable="contained" color="primary" component="span" name="file" >
                                {this.state.fileName === "" ? "Select image file" : this.state.fileName}
                            </Button>
                        </label>
                        <br/>
                        ...
                        <TextField label="Gender" type="text" name="gender" value={this.state.value} onChange={this.handleValueChange} /><br />
